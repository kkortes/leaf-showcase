<div class="drop left top base-padding sharer">
	...
	<div class="drop down-left base-padding" style="padding-top:25px;">
		<a href="https://twitter.com/share" class="twitter-share-button" data-url="http://getleaf.com" data-text="Check out Leaf CSS Framework!" data-via="kortekim" data-hashtags="materialdesign, leaf">Tweet</a>
