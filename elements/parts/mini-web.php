<div class="clearfix text-white" style="background:#fafafa;">
	...
	<div class="fill-blue fill-minus-2 base-padding clearfix">
		<div class="relative pull-left" style="padding-top:4px;">
			...
			<div class="drop down left fill-white card" style="width:200px;">
				<ul class="unstyled">
					<li>
	...
	<div class="base-padding" style="padding-right:0;">
		...
		<div class="tile fill-white pull-left text-grey text-plus-3" style="margin:0 8px 8px 0;">
